...
@implementation SMMatcheeDeliveryMessage

+ (instancetype)modelObjectWithDictionary:(NSDictionary*)dict
{
    SMMatcheeDeliveryMessage *instance = [[SMMatcheeDeliveryMessage alloc] initWithDictionary:dict];
    return instance;
}
